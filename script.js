...
(() => {
  ...
  const T = {
      ...
      'menu-lead': 'Aitoja raaka-aineita, hitaasti kohoavaa taikinaa — ruokaa, josta olemme ylpeitä.',
      ...
      'story-p1': 'Hyvä pizza vaatii aikaa. Taikinamme kohoaa hitaasti, raaka-aineet valitaan huolella — eikä mikään turha tule maun tielle.',
    ...
    en: {
      ...
      'menu-lead': 'Real ingredients, slow-risen dough — food we\'re proud to serve.',
      ...
      'story-p1': 'Good pizza takes time. Our dough rises slowly, our ingredients are carefully chosen, and nothing unnecessary gets in the way of the flavour.',
      'visit-num': '04 — Visit',
      'visit-title1': 'Come',
